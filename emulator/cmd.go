...
func Run() error {
	...
	app.Flag("credentials", "NATS credentials to use when connecting").ExistingFileVar(&credentials)
	...
	app.Flag("server", "NATS Server pool, specify multiple times (eg one:4222)").StringsVar(&brokers)
